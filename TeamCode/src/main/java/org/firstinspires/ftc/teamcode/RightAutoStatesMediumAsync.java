...
@Autonomous (name = "Right Auto States Medium Async")
public class RightAutoStatesMediumAsync extends LinearOpMode {
    Brobot robot;
    //ColorSensor color;
    ...
    public void runOpMode()
    {
        ...
        TrajectorySequence trajSeq2 = robot.trajectorySequenceBuilder(trajSeq.end())
                ...
                .addTemporalMarker(0.75, () -> {
                    carousel.setTargetPosition((int) (90*ppr/360.0));
                    carousel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    carousel.setPower(1);
                })
        ...
        TrajectorySequence parkRight = robot.trajectorySequenceBuilder(trajSeq.end())
                .lineToConstantHeading(new Vector2d(60.5, -11))
                .addTemporalMarker(0, () ->{
                    carousel.setTargetPosition(0);
                    carousel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    carousel.setPower(1);
        ...
        TrajectorySequence parkMiddle = robot.trajectorySequenceBuilder(trajSeq.end())
                .lineToConstantHeading(new Vector2d(36.5, -11))
                .addTemporalMarker(0, () ->{
                    carousel.setTargetPosition(0);
                    carousel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    carousel.setPower(1);
        ...
        TrajectorySequence parkLeft = robot.trajectorySequenceBuilder(trajSeq.end())
                .lineToConstantHeading(new Vector2d(14.5, -11))
                .addTemporalMarker(0, () ->{
                    carousel.setTargetPosition(0);
                    carousel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    carousel.setPower(1);
